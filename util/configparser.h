...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    VAR_ANSWER_COOKIE = 538,       /* VAR_ANSWER_COOKIE  */
    VAR_COOKIE_SECRET = 539,       /* VAR_COOKIE_SECRET  */
    VAR_FORWARD_NO_CACHE = 540,    /* VAR_FORWARD_NO_CACHE  */
    VAR_STUB_NO_CACHE = 541,       /* VAR_STUB_NO_CACHE  */
    VAR_LOG_SERVFAIL = 542,        /* VAR_LOG_SERVFAIL  */
    VAR_DENY_ANY = 543,            /* VAR_DENY_ANY  */
    VAR_UNKNOWN_SERVER_TIME_LIMIT = 544, /* VAR_UNKNOWN_SERVER_TIME_LIMIT  */
    VAR_LOG_TAG_QUERYREPLY = 545,  /* VAR_LOG_TAG_QUERYREPLY  */
    VAR_STREAM_WAIT_SIZE = 546,    /* VAR_STREAM_WAIT_SIZE  */
    VAR_TLS_CIPHERS = 547,         /* VAR_TLS_CIPHERS  */
    VAR_TLS_CIPHERSUITES = 548,    /* VAR_TLS_CIPHERSUITES  */
    VAR_TLS_USE_SNI = 549,         /* VAR_TLS_USE_SNI  */
    VAR_IPSET = 550,               /* VAR_IPSET  */
    VAR_IPSET_NAME_V4 = 551,       /* VAR_IPSET_NAME_V4  */
    VAR_IPSET_NAME_V6 = 552,       /* VAR_IPSET_NAME_V6  */
    VAR_TLS_SESSION_TICKET_KEYS = 553, /* VAR_TLS_SESSION_TICKET_KEYS  */
    VAR_RPZ = 554,                 /* VAR_RPZ  */
    VAR_TAGS = 555,                /* VAR_TAGS  */
    VAR_RPZ_ACTION_OVERRIDE = 556, /* VAR_RPZ_ACTION_OVERRIDE  */
    VAR_RPZ_CNAME_OVERRIDE = 557,  /* VAR_RPZ_CNAME_OVERRIDE  */
    VAR_RPZ_LOG = 558,             /* VAR_RPZ_LOG  */
    VAR_RPZ_LOG_NAME = 559,        /* VAR_RPZ_LOG_NAME  */
    VAR_DYNLIB = 560,              /* VAR_DYNLIB  */
    VAR_DYNLIB_FILE = 561,         /* VAR_DYNLIB_FILE  */
    VAR_EDNS_CLIENT_STRING = 562,  /* VAR_EDNS_CLIENT_STRING  */
    VAR_EDNS_CLIENT_STRING_OPCODE = 563, /* VAR_EDNS_CLIENT_STRING_OPCODE  */
    VAR_NSID = 564                 /* VAR_NSID  */
  };
...
#define VAR_ANSWER_COOKIE 538
#define VAR_COOKIE_SECRET 539
#define VAR_FORWARD_NO_CACHE 540
#define VAR_STUB_NO_CACHE 541
#define VAR_LOG_SERVFAIL 542
#define VAR_DENY_ANY 543
#define VAR_UNKNOWN_SERVER_TIME_LIMIT 544
#define VAR_LOG_TAG_QUERYREPLY 545
#define VAR_STREAM_WAIT_SIZE 546
#define VAR_TLS_CIPHERS 547
#define VAR_TLS_CIPHERSUITES 548
#define VAR_TLS_USE_SNI 549
#define VAR_IPSET 550
#define VAR_IPSET_NAME_V4 551
#define VAR_IPSET_NAME_V6 552
#define VAR_TLS_SESSION_TICKET_KEYS 553
#define VAR_RPZ 554
#define VAR_TAGS 555
#define VAR_RPZ_ACTION_OVERRIDE 556
#define VAR_RPZ_CNAME_OVERRIDE 557
#define VAR_RPZ_LOG 558
#define VAR_RPZ_LOG_NAME 559
#define VAR_DYNLIB 560
#define VAR_DYNLIB_FILE 561
#define VAR_EDNS_CLIENT_STRING 562
#define VAR_EDNS_CLIENT_STRING_OPCODE 563
#define VAR_NSID 564
