...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    VAR_ANSWER_COOKIE = 534,       /* VAR_ANSWER_COOKIE  */
    VAR_COOKIE_SECRET = 535,       /* VAR_COOKIE_SECRET  */
    VAR_FORWARD_NO_CACHE = 536,    /* VAR_FORWARD_NO_CACHE  */
    VAR_STUB_NO_CACHE = 537,       /* VAR_STUB_NO_CACHE  */
    VAR_LOG_SERVFAIL = 538,        /* VAR_LOG_SERVFAIL  */
    VAR_DENY_ANY = 539,            /* VAR_DENY_ANY  */
    VAR_UNKNOWN_SERVER_TIME_LIMIT = 540, /* VAR_UNKNOWN_SERVER_TIME_LIMIT  */
    VAR_LOG_TAG_QUERYREPLY = 541,  /* VAR_LOG_TAG_QUERYREPLY  */
    VAR_STREAM_WAIT_SIZE = 542,    /* VAR_STREAM_WAIT_SIZE  */
    VAR_TLS_CIPHERS = 543,         /* VAR_TLS_CIPHERS  */
    VAR_TLS_CIPHERSUITES = 544,    /* VAR_TLS_CIPHERSUITES  */
    VAR_TLS_USE_SNI = 545,         /* VAR_TLS_USE_SNI  */
    VAR_IPSET = 546,               /* VAR_IPSET  */
    VAR_IPSET_NAME_V4 = 547,       /* VAR_IPSET_NAME_V4  */
    VAR_IPSET_NAME_V6 = 548,       /* VAR_IPSET_NAME_V6  */
    VAR_TLS_SESSION_TICKET_KEYS = 549, /* VAR_TLS_SESSION_TICKET_KEYS  */
    VAR_RPZ = 550,                 /* VAR_RPZ  */
    VAR_TAGS = 551,                /* VAR_TAGS  */
    VAR_RPZ_ACTION_OVERRIDE = 552, /* VAR_RPZ_ACTION_OVERRIDE  */
    VAR_RPZ_CNAME_OVERRIDE = 553,  /* VAR_RPZ_CNAME_OVERRIDE  */
    VAR_RPZ_LOG = 554,             /* VAR_RPZ_LOG  */
    VAR_RPZ_LOG_NAME = 555,        /* VAR_RPZ_LOG_NAME  */
    VAR_DYNLIB = 556,              /* VAR_DYNLIB  */
    VAR_DYNLIB_FILE = 557,         /* VAR_DYNLIB_FILE  */
    VAR_EDNS_CLIENT_STRING = 558,  /* VAR_EDNS_CLIENT_STRING  */
    VAR_EDNS_CLIENT_STRING_OPCODE = 559 /* VAR_EDNS_CLIENT_STRING_OPCODE  */
  };
...
#define VAR_ANSWER_COOKIE 534
#define VAR_COOKIE_SECRET 535
#define VAR_FORWARD_NO_CACHE 536
#define VAR_STUB_NO_CACHE 537
#define VAR_LOG_SERVFAIL 538
#define VAR_DENY_ANY 539
#define VAR_UNKNOWN_SERVER_TIME_LIMIT 540
#define VAR_LOG_TAG_QUERYREPLY 541
#define VAR_STREAM_WAIT_SIZE 542
#define VAR_TLS_CIPHERS 543
#define VAR_TLS_CIPHERSUITES 544
#define VAR_TLS_USE_SNI 545
#define VAR_IPSET 546
#define VAR_IPSET_NAME_V4 547
#define VAR_IPSET_NAME_V6 548
#define VAR_TLS_SESSION_TICKET_KEYS 549
#define VAR_RPZ 550
#define VAR_TAGS 551
#define VAR_RPZ_ACTION_OVERRIDE 552
#define VAR_RPZ_CNAME_OVERRIDE 553
#define VAR_RPZ_LOG 554
#define VAR_RPZ_LOG_NAME 555
#define VAR_DYNLIB 556
#define VAR_DYNLIB_FILE 557
#define VAR_EDNS_CLIENT_STRING 558
#define VAR_EDNS_CLIENT_STRING_OPCODE 559
